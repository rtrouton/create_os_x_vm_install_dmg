...
Description:
Converts a 10.7/10.8/10.9/10.10/10.11 installer image to a new image that contains components
...
if [[ -e "$FIRSTBOOT_PKG" ]]; then
   msg_status "$FIRSTBOOT_PKG detected. Proceeding..."
	...
	msg_status "which will generate a distribution-style flat package that can be used with 10.7 / 10.8 / 10.9 / 10.10 / 10.11 OS installs."
	msg_status ""
